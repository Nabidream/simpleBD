...
<tr height=25 bgcolor=white>
	<!-- 번호 -->
	<td align=center>
	<a href="main.php?rightView=./service/post/postDetail.php&POSTID=<?php echo $row['postID']?>&NO=<?php echo $no?>">
		<?php echo $row['postID']?></a>
	</td>
	<!-- 번호 끝 -->
	<!-- 제목 -->
	<td>&nbsp;
...
<a href="main.php?rightView=./service/post/postWrite.php" align="left">[글쓰기]</a>
<br>
<br>
